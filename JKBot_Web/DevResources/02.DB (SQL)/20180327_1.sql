...
-- 테이블 jkbot.jk_coin_mapping 구조 내보내기
DROP TABLE IF EXISTS `jk_coin_mapping`;
CREATE TABLE IF NOT EXISTS `jk_coin_mapping` (
...
-- 테이블 데이터 jkbot.jk_coin_mapping:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `jk_coin_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `jk_coin_mapping` ENABLE KEYS */;
...
-- 테이블 데이터 jkbot.jk_exchange_mapping_info:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `jk_exchange_mapping_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `jk_exchange_mapping_info` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `jk_user_info` (
  ...
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='사용자 테이블';

-- 테이블 데이터 jkbot.jk_user_info:~1 rows (대략적) 내보내기
